    ...
    return (
      <div className="about-container" ref="about">
        ...
        <p className="about-text">
          ...
          organized and timely fashion. My goal is to obtain a developer
          position with emphasis on creation of applications geared towards
          presentation and analysis of biological phenomena.
          <br />
          <br />
